...
export function useMenuSetting() {
  ...
  const getIsMixType = computed(() => unref(getMenuType) === MenuTypeEnum.MIX);
  ...
  const getIsMixMode = computed(() => {
    return unref(getMenuMode) === MenuModeEnum.INLINE && (unref(getMenuType) === MenuTypeEnum.MIX || unref(getMenuType) === MenuTypeEnum.SIDEBAR );
  });
